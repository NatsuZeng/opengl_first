package specter3d.engine.core.camera
{
	...
	public class Camera3D extends Object3D
	{
		...
		public function Camera3D(lens:Lens3D=null)
		{
			...
			this.transform.on(Event3D.UPDATE_TRANSFORM, onUpdateTransform);
		}
		...
		private var _viewProjection:Matrix4x4=new Matrix4x4(); // view projection
		 ...
		 *
		 */
		public function getPointDir(x:Number, y:Number, out:Vector3=null):Vector3
		{
			if (!out)
			{
				out=new Vector3();
		...
		public function set lens(value:Lens3D):void
		{
			if (this._lens)
			{
				this._lens.off(Lens3DEvent.PROJECTION_UPDATE, onLensProjChanged);
			}
			this._lens=value;
			this._lens.on(Lens3DEvent.PROJECTION_UPDATE, onLensProjChanged);
		}
		 ...
		 *
		 */
		public function get viewProjection():Matrix4x4
		{
