package specter3d.engine.loaders
{
	...
	public class GameLoader
	{
		 ...
		 *预加载  
		 */		
		public static const PRELOADE_LEVEL:int	= -10;
		
		/**
		 *最小等级 
		 */		
		public static const MIN_LEVEL:int		= 5;
		
		/**
		 *正常等级 
		 */		
		public static const NORMAL_LEVEL:int	= 10;
		
		/**
		 *ui等级 
		 */		
		public static const UI_LEVEL:int 		= 50;
		
		/**
		 *最高等级 
		 */		
		public static const HEIGHT_LEVEL:int	= 100;
		
		/**
		 *加载 数 
		 */		
		private static const MAX_PARALLEL_NUM:int = 3;
		...
		{
			Debug.dotrace(Debug.ENGINE,"GameLoader init.");
			if(_loaderPool.length > 0)
				return;
			for (var i:int = 0; i < MAX_PARALLEL_NUM; i++)
			{
		...
		{
			doAdd(resourceVo, callbackHandler, group);
		} 
