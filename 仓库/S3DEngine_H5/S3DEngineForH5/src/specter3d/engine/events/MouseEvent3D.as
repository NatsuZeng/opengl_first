package specter3d.engine.events
{
	...
	{
		// Private.
		specter3d var _allowedToPropagate:Boolean = true;
		specter3d var _parentEvent:MouseEvent3D;
		...
		{
			var doesBubble:Boolean = _allowedToPropagate;
