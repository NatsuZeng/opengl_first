package specter3d.engine.managers
{
	 ...
	 */
	public class NativeEventManager extends EventDispatcher {
		/**
		 * MouseManager 单例引用。
		 */
		public static const instance:NativeEventManager = new NativeEventManager();
		...
		public function __init__(canvas:*):void {
			var _this:NativeEventManager = this;
