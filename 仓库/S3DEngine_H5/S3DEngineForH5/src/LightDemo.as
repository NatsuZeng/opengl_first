package
{
	 ...
	 * @author wangcx
	 */
	public class LightDemo implements IRenderUpdate
	{
		...
		{
			var _3dsGeometry:Geometry3D=AssetLib.getAsset("asset/3ds/Teapot.3ds", "LightDemo._loaded") as Geometry3D;
			var _3dsImage:HTMLImage=AssetLib.getImage("asset/3ds/Fieldstone.png", "LightDemo._loaded");
		...
		{
			var _lightPicker:LightPicker = new LightPicker(Vector.<LightBase>[_pLight,_pLight2,_pLight3,_pLight4]);
		...
		private function initEngine():void
		{
			...
			Debug.dotrace("wangcx", "LightDemo.initEngine()");
