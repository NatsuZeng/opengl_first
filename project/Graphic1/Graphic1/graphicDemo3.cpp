...
int main()
{
	...
	Shader lampShader("shader/lamp.vs", "shader/lamp.f");
	Shader objectShader("shader/lighting_maps.vs", "shader/lighting_maps.f");
	...
	unsigned int VBO, objectVAO,lampVAO;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, contatiner);
		glActiveTexture(GL_TEXTURE1);
		glBindTexture(GL_TEXTURE_2D, contatiner1);
