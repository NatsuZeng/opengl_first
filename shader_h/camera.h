...
public:
	...
	glm::mat4 GetViewMatrix()
	{
		...
		return calculate_lookAt_matrix(Position, Position + Front/*glm::vec3(0.0f, 0.0f, 0.0f)*/, WorldUp);
	}
...
private:
	...
	void updateCameraVectors()
	{
		...
		//also recaculate the Right and Up vector
	...
	glm::mat4 calculate_lookAt_matrix(glm::vec3 position, glm::vec3 target, glm::vec3 worldUp)
	{
		...
		translation[3][0] = -position.x;// Fourth(Array start from 0 to 3) column, first row
